...
export default function Home() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      {/* LEFT SIDE – YOUR EXISTING DESIGN (UNCHANGED) */}
      <div className="flex justify-center items-center">
        <Card className="w-full max-w-md">
          <CardTitle className="text-center text-[#1F2050] font-bold">
            Welcome Back!
          </CardTitle>
      ...
      {/* RIGHT SIDE – DARK BLUE BACKGROUND ONLY */}
      <div className="hidden md:block bg-[#1F2050]" />
